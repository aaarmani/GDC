...
/**
 * Recupera e disponibiliza informações do <code>MANIFEST_.MF</code> para o aplicativo.
 *
...
public class ApplicationProperties {
    ...
    static {
        try {
            Enumeration<URL> resources = ApplicationProperties.class.getClassLoader().getResources("META-INF/MANIFEST_.MF");
