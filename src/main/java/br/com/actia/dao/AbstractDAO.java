 ...
 *
 * <p>Define as operações básicas de cadastro para cada tipo de entidade.
 * (<strong>C</strong>reate / <strong>R</strong>ead / <strong>U</strong>pdate /
 * <strong>D</strong>elete)</p> <p>Dessa forma os componentes
 * <code>DAO</code> das entidades, a priori, não devem se preocupar com essas
 * funcionalidades.</p> <p>Efetivamente, na <code>JPA</code>, todas as operações 
 * de persistência são realizadas pelo componente
 * <code>EntityManager</code>, por isso dependemos desse componente.
 *
